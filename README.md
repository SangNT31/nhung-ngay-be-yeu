...
Ảnh được tự động tải theo kích thước màn hình (tối đa `maxImageWidth`, mặc định 1600px) để giảm dung lượng. Có thể hạ giá trị này trong `config.js` nếu ưu tiên tốc độ hơn độ phân giải.
